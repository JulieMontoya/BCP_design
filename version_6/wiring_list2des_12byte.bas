...
18810=N$
18820DEFFNfpnum($&9C0):LOCALU%
18830PROCpoke(ssb,&9C0):U%=USRfind_fp:IFU%AND&1000000THEN=-1 ELSE=(U%AND&FF00)DIV256
18840DEFPROCaddfp(F$):LOCALF%
18850PROCdesign:IFFNfpnum(F$)>=0PRINT"Already in design":GOTO18880
18860PROCmaster:F%=FNfpnum(F$):IFF%<0PRINT"Not in master":GOTO18880
18870PROCcopyfp(F%)
18880ENDPROC
